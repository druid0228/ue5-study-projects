...
AProjectile::AProjectile()
{
	...
	ProjecttileMovementComponent = CreateDefaultSubobject<UProjectileMovementComponent>(TEXT("ProjecttileMovementComponent"));
	ProjecttileMovementComponent->InitialSpeed = 1000.0f;
	ProjecttileMovementComponent->MaxSpeed = 1000.0f;
